...
export default class Create extends Component {
  constructor(props) {
    ...
    this.onChangeDeviseName = this.onChangeDeviseName.bind(this);
    this.onChangeDeviseField = this.onChangeDeviseField.bind(this);
    this.onChangeDeviseDescription = this.onChangeDeviseDescription.bind(this);
    this.onChangeDeviseImage = this.onChangeDeviseImage.bind(this);
    this.onChangeDeviseAvailability = this.onChangeDeviseAvailability.bind(this);
